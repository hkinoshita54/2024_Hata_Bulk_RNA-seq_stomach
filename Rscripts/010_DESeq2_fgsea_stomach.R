...
write.table(res,paste0("results/DEG/stomach/", description, ".txt"), sep ="\t", col.names = T, row.names = F)
...
write.table(fgseaRes, paste0("results/DEG/stomach/GSEA_H_", description, ".txt"), sep ="\t", col.names = TRUE, row.names = FALSE)
...
ggsave(paste0("GSEA_H_Up_", description, ".png"), path = "plots/stomach", width = 3.5, height = 0.5 + nrow(fgseaResUp)/8, units = "in", dpi = 300) 
