...
## Load data ----
cts <- read.delim(file = "data/salmon/salmon.merged.gene_counts.tsv", header = TRUE, sep = "\t")
...
write.table(res,"results/DEG/organoid_PTC_vs_PC_salmon.txt", sep ="\t", col.names = T, row.names = F)
