...
analysis_step <- "201_GCclassifier_PTC_KPT"
...
# Load data ----
cts <- read.delim(file = "data/Bulk_stomach_T1PTC_T1KPT.txt", header = TRUE, sep = "\t")
...
### make coldata
coldata <- data.frame(condition = c("WT", "WT", "PT", "PT", "PC", "PC", "TC", "TC", "PTC", "PTC", "KP", "KP", "KT", "KT", "KPT", "KPT"))
rownames(coldata) <- colnames(cts)
coldata$condition <- factor(coldata$condition, levels = c("WT", "PT", "PC", "TC", "PTC", "KP", "KT", "KPT"))
