...
venn.diagram(x = list(PTCvsWTup, TCvsWTup, PTCvsWTup_sto, TCvsWTup_sto), 
             ...
             filename = 'plots/organoid/venn_diagramm_top300.png', output = TRUE, disable.logging = TRUE,
...
write.table(DE_list, file = "results/DEG/DEG_list_top300.txt", sep = "\t", row.names = FALSE)
